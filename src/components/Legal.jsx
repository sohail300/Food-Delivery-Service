                ...
                <Accordion className='py-2'>
                    ...
                    <AccordionDetails>
                        ...
                        <div className='text-sm text-zinc-950 opacity-60 font-proximaLight mt-4'>
                            b)If you cancel your order after one minute of placing it, Swiggy shall have a right to charge you 100% of the order amount as the cancellation fee , with a right to either not to refund the order value in case your order is prepaid or recover from your subsequent order in case your order is postpaid, to compensate our restaurant/merchants and delivery partners.
                        </div>
                        <div className='text-sm text-zinc-950 opacity-60 font-proximaLight mt-4'>
